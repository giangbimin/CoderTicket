...
e = Event.create({
  ...
  starts_at: DateTime.parse((Time.zone.now + 10.days).to_s),
  ends_at: DateTime.parse((Time.zone.now + 30.days).to_s),
  venue: dalat,
...
e = Event.create({
  ...
  starts_at: DateTime.parse((Time.zone.now + 30.days).to_s),
  ends_at: DateTime.parse((Time.zone.now + 100.days).to_s),
  venue: gap,
  category: Category.find_by(name: 'Entertainment'),
